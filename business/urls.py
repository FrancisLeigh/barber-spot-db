...
urlpatterns = [
  ...
  url(r'^shops/(?P<shop_id>[0-9]+)/chairs/$', views.ShopChairsView.as_view(), name='shop_chairs'),

  # /business/shops/<shop_id>/chairs/<chair_id>
  url(r'^shops/(?P<shop_id>[0-9]+)/chairs/(?P<chair_id>[0-9]+)/$', views.ChairsView.as_view(), name='shop_chair'),

  #/business/chairs/
  url(r'^chairs/$', views.ChairsView.as_view(), name='chairs'),

  #/business/chairs/<chair_id>
  url(r'^chairs/(?P<chair_id>[0-9]+)$', views.ChairsView.as_view(), name='chairs'),
